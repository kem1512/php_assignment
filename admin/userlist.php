                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr style="font-size: 16px;">
                                                <td class="align-middle"><?php echo $row['adminId'] ?></td>
                                                <td class="align-middle"><?php echo $row['adminName'] ?></td>
                                                <td class="align-middle"><?php echo $row['adminEmail'] ?></td>
                                                <td class="text-center">
                                                    <a class="btn btn-primary" href="useredit.php?idEdit=<?php echo $row['adminId']; ?>&nameEdit=<?php echo $row['adminName'] ?>&emailEdit=<?php echo $row['adminEmail'] ?>">Sửa người dùng</a>
                                                    <a class="btn btn-danger" onclick="return confirm ('Bạn có chắc chắn muốn xóa người dùng này không?');" href="userlist.php?delid=<?php echo $row['adminId']; ?>">Xóa người dùng</a>
                                                </td>
                                            </tr>
                                    <?php
                                        }
