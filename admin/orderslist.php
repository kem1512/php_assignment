...
<body class="sb-nav-fixed">
    ...
    ?>
    <?php
    $list_product = new orders();
    if (isset($_GET['delId'])) {
        $delId = $list_product->delete_orders($_GET['delId']);
    }
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    <?php
                                    $product = $list_product->show_orders();
                                    if ($product) {
                                    ...
                                    ?>
                                            <tr style="font-size: 16px;">
                                                ...
                                                <td class="align-middle"><?php echo(date("d-m-Y h:i:s", $row['date_order'])); ?></td>
                                                <td class="align-middle text-center"><?php echo $row['phone'] ?></td>
                                                <td class="align-middle text-center"><?php echo $row['address'] ?></td>
                                                <td class="align-middle text-center">
                                                    <a class="btn btn-danger" onclick="return confirm ('Bạn có chắc chắn muốn xóa sản phẩm này không?');" href="orderslist.php?delId=<?php echo $row['id'] ?>">Xóa đơn hàng</a>
                                                </td>
                                            </tr>
                                    <?php
                                        }
