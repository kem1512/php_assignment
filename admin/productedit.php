...
<body class="sb-nav-fixed">
    ...
    if (isset($_POST['txtName']) && isset($_POST['txtDesc']) && isset($_POST['txtPrice'])) {
        $update_product = $list_product->update_product($_POST['txtName'], $_POST['txtDesc'], $_POST['txtPrice'], $fileName, $_POST['categories'],$id);
    }
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <input name="txtName" type="text" class="form-control" value="<?php if (isset($_GET['nameEdit'])) echo $_GET['nameEdit'] ?>">
                                            </td>
                                            <td class="align-middle">
                                                <input name="txtDesc" type="text" class="form-control" value="<?php if (isset($_GET['desc'])) echo $_GET['desc'] ?>">
                                            </td>
                                            <td class="align-middle">
                                                <input name="txtPrice" type="text" class="form-control" value="<?php if (isset($_GET['price'])) echo number_format($_GET['price'], 0, ",", ".") ?>">
                                            </td>
                                                ...
                                                <div class="input-group justify-content-center">
                                                    <span class="" id="basic-addon1">
                                                        <select name="categories" class="form-select">
                                                            <?php
                                                            if (isset($_GET['catId'])) {
                                                                $vip = $list_product->show_categories();
                                                                if ($vip) {
                                                                    while ($row1 = $vip->fetch_assoc()) {
                                                            ?>
