...
<body>
    <?php
        //Khởi tạo đối tượng từ user_classes
        $user = new user_class();
            ...
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                <form class="login100-form validate-form" action="login.php" method="post">
                    ...
                    <div class="wrap-input100 validate-input m-b-23" data-validate="Bạn phải nhập email">
                        ...
                        <input class="input100" type="text" name="adminEmail" placeholder="Nhập email của bạn">
                        <span class="focus-input100" data-symbol="&#xf206;"></span>
                    </div>

                    <div class="wrap-input100 validate-input" data-validate="Bạn phải nhập mật khẩu">
                        <span class="label-input100">Mật khẩu</span>
                        <input class="input100" type="password" name="adminPass" placeholder="Nhập mật khẩu của bạn">
                        <span class="focus-input100" data-symbol="&#xf190;"></span>
                    </div>
